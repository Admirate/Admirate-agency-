    ...
    <section className="min-h-[50svh] md:min-h-[50vh] bg-black relative overflow-hidden flex items-center justify-center py-8 md:py-12">
      <div className="container mx-auto px-4 md:px-8">
        <div className="text-center space-y-8 md:space-y-12">
          ...
          >
            <h2
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight text-white mb-3 md:mb-4"
              style={{
                fontFamily:
            ...
            <p
              className="text-base sm:text-lg md:text-xl lg:text-2xl text-red-500 font-medium"
