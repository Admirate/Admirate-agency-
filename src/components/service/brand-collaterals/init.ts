 ...
 *
 * The page carries no scroll set-piece of its own — the range is a static
 * list and the wall is a CSS marquee — so this is only the shared furniture:
 * the section rail, the progress line, and the fixed background that takes
 * its colour from whichever section is under the middle of the viewport.
 */
